...
function _focusPreviewIframe(iframe) {
  if (!iframe) return;
...
async function _createAndAppendPane(m) {
  ...
  pane.innerHTML =
    ...
    '<iframe class="compare-pane-iframe" id="cmp-iframe-' + i + '" sandbox="allow-scripts" tabindex="0" title="Compare HTML preview" style="display:none;"></iframe>' +
