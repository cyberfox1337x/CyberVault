            ...
            try:
                for dp, dns, fns in os.walk(base):
                    ...
                    dns[:] = [
                        ...
                        and not _is_sensitive_path(os.path.realpath(os.path.join(dp, d)))
                    ]
                    for name in fns + dns:
    ...
    async def execute(self, content: str, ctx: dict) -> dict:
        ...
        def _grep():
            ...
            if rg:
                ...
                if glob_pat:
                    cmd += ["--glob", glob_pat]
                for _name in _SENSITIVE_BASENAMES:
                    cmd += ["--glob", f"!**/{_name}", "--glob", f"!**/{_name}/**"]
                ...
                try:
                    ...
                    for ln in (p.stdout or "").splitlines():
                        ...
                        if _is_sensitive_path(os.path.realpath(path_part)):
                            continue
                        lines.append(ln)
