...
def _int_setting(getter: Callable[[str, int], Any], name: str, default: int) -> int:
...
class TaskScheduler:
    ...
    async def _execute_research_task(self, task, db) -> str:
        ...
        max_tokens = _int_setting(get_setting, "research_max_tokens", 8192)
        extraction_timeout = _int_setting(get_setting, "research_extraction_timeout_seconds", 90)
        extraction_concurrency = _int_setting(get_setting, "research_extraction_concurrency", 3)
