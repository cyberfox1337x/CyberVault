...
_SENSITIVE_BASENAMES_CASEFOLD: set[str] = {
    name.casefold() for name in _SENSITIVE_BASENAMES
}
_SENSITIVE_FILE_PATTERNS_CASEFOLD: tuple[str, ...] = tuple(
    name.casefold() for name in _SENSITIVE_FILE_PATTERNS
)
